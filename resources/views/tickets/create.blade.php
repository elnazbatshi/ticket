    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10">
                ...
                @endif
                <div class="card">
                    <div class="card-header text-right">ثبت تیکت</div>
{{--                    @dd($categories)--}}
                    <div class="card-body">
                        <form method="POST" action="{{ route('tickets.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label for="title"
                                       class="col-md-4 col-form-label text-md-right">@lang('cruds.ticket.fields.title')</label>
                            ...
                            <div class="form-group row">
                                <label for="title" class="col-md-4 col-form-label text-md-right">الویت ها </label>

                                <div class="col-md-6 ">
                                    <select name="priority_id" class="form-select form-control "
                            ...
                            <div class="form-group row">
                                <label for="title" class="col-md-4 col-form-label text-md-right">دسته بندی ها</label>
...
{{--                                        <option value="1">سایر</option>--}}
                            ...
                            <div class="form-group row">
                                <label for="content"
                                       class="col-md-4 col-form-label text-md-right">@lang('cruds.ticket.fields.content')</label>
